...
const REMOVALS = [
    { id: '2016953670030463363', username: 'MB_Hogan' }, // NBIS - Market Data Failed
    { id: '2016255717012078702', username: 'MB_Hogan' }, // NBIS - Market Data Failed
    { id: '2017129959345762414', username: 'Cryptolution' }, // DOG - Market Data Failed
    { id: '2017329591262842951', username: 'Cryptolution' }, // DOG - Market Data Failed
    { id: '2017290243880456398', username: 'Cryptolution' }  // DOG - Market Data Failed
];

async function removeFailed() {
    console.log(`🗑 Removing ${REMOVALS.length} failed tweets (Batch 6)...`);
