...
const REMOVALS = [
    { id: '2013359893537857841', username: 'lynk0x' },       // WHITEWHALE
    { id: '2016251281162006886', username: 'ciniz' },        // CRYPTO
    { id: '2017277409410863179', username: 'xLabundahx' }    // DOG
];

async function removeBatch() {
    console.log(`🗑 Removing ${REMOVALS.length} failed/untrackable tweets...`);
