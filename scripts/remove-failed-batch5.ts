...
const REMOVALS = [
    { id: '2017185931019862255', username: 'devchart' }, // MEGA - Market Data Failed
    { id: '2016534781245469036', username: 'JamesWynnReal' } // PENGUIN - Market Data Failed
];

async function removeFailed() {
    console.log(`🗑 Removing ${REMOVALS.length} failed tweets (Batch 5)...`);
