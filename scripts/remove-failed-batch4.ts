...
const REMOVALS = [
    { id: '2017311543805788593', username: 'theunipcs' }, // USELESS - Market Data Failed
    { id: '2016895412259434518', username: 'Jova_Beta' }  // DOG - Market Data Failed
];

async function removeFailed() {
    console.log(`🗑 Removing ${REMOVALS.length} failed tweets...`);
