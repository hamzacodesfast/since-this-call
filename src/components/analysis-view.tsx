                    ...
                    <CardHeader className="pb-4 relative z-10">
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-4">
                            ...
                            <div className="flex gap-2 flex-shrink-0 self-start sm:self-auto flex-wrap">
                                <Badge variant="outline" className={cn("opacity-70 bg-background/50 backdrop-blur-md text-[10px] whitespace-nowrap w-fit flex-none px-3 py-1 h-6",
                                ...
                                <Badge variant="outline" className="opacity-70 bg-background/50 backdrop-blur-md text-[10px] whitespace-nowrap w-fit flex-none px-3 py-1 h-6">
