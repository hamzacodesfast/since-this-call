...
export default function LeaderboardPage() {
    ...
    // Filter to min 15 calls and sort
    const qualified = profiles.filter(p => p.totalAnalyses >= 15);
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <Card className="border-green-500/20 bg-background/40">
                                <CardHeader className="pb-4">
                                    ...
                                    <p className="text-xs text-muted-foreground">Minimum 15 calls required</p>
                                </CardHeader>
                            ...
                            <Card className="border-red-500/20 bg-background/40">
                                <CardHeader className="pb-4">
                                    ...
                                    <p className="text-xs text-muted-foreground">Minimum 15 calls required | Fade signal?</p>
                                </CardHeader>
